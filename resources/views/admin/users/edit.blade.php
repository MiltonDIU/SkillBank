                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\FeedbackCategory::IS_ACTIVE_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('if_admin_message') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="if_admin_message{{ $key }}" name="if_admin_message" value="{{ $key }}" {{ old('if_admin_message', $user->if_admin_message) === (string) $key ? 'checked' : '' }} required>
