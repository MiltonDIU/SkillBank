        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.socials.update", [$social->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $social->title) }}" required>
                    @if($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $social->url) }}" required>
                    @if($errors->has('url'))
                        <div class="invalid-feedback">
                            {{ $errors->first('url') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('icon_class_name') ? 'is-invalid' : '' }}" type="text" name="icon_class_name" id="icon_class_name" value="{{ old('icon_class_name', $social->icon_class_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Social::IS_ACTIVE_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $social->is_active) === (string) $key ? 'checked' : '' }} required>
