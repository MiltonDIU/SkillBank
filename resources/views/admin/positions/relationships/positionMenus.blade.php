...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-positionMenus">
                <thead>
                <tr>
                    <th width="10">
                ...
                @foreach($menus as $key => $menu)
                    <tr data-entry-id="{{ $menu->id }}">
                        ...
                        <td>
                            @foreach($menu->positions as $key => $item)
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            let table = $('.datatable-positionMenus:not(.ajaxTable)').DataTable({ buttons: dtButtons })
