        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.countries.update", [$country->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('num_code') ? 'is-invalid' : '' }}" type="text" name="num_code" id="num_code" value="{{ old('num_code', $country->num_code) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('code_2') ? 'is-invalid' : '' }}" type="text" name="code_2" id="code_2" value="{{ old('code_2', $country->code_2) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('code_3') ? 'is-invalid' : '' }}" type="text" name="code_3" id="code_3" value="{{ old('code_3', $country->code_3) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nationality') ? 'is-invalid' : '' }}" type="text" name="nationality" id="nationality" value="{{ old('nationality', $country->nationality) }}" required>
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Country::IS_ACTIVE_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $country->is_active) === (string) $key ? 'checked' : '' }}>
