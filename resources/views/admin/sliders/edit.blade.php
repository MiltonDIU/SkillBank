        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content">{!! old('content', $slider->content) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('get_started_text') ? 'is-invalid' : '' }}" type="text" name="get_started_text" id="get_started_text" value="{{ old('get_started_text', $slider->get_started_text) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('get_started_url') ? 'is-invalid' : '' }}" type="text" name="get_started_url" id="get_started_url" value="{{ old('get_started_url', $slider->get_started_url) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('learn_more_text') ? 'is-invalid' : '' }}" type="text" name="learn_more_text" id="learn_more_text" value="{{ old('learn_more_text', $slider->learn_more_text) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('learn_more_url') ? 'is-invalid' : '' }}" type="text" name="learn_more_url" id="learn_more_url" value="{{ old('learn_more_url', $slider->learn_more_url) }}">
                ...
                <div class="form-group">
                    ...
                    @foreach(App\Models\Slider::IS_ACTIVE_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $slider->is_active) === (string) $key ? 'checked' : '' }}>
